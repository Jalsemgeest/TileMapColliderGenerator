...
##
##   @export_placeholder("TileMapActionProperty") var ...
##
...
class TileMapActionPropertyEditor:
...
func _can_handle(object: Object) -> bool:
	if object is TileMapCollisionGenerator:
		return true
	return false
...
func _parse_property(
	...
	if hint_string == "TileMapActionProperty":
		var prop_editor := TileMapActionPropertyEditor.new()
